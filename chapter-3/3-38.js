// Different possible values for balance after all three transactions have been completed, 
// assuming that the banking system forces the three threads to run sequentially in some order: 
