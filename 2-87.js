// Install is_equal_to_zero for polynomials in the generic arithmetic package. 
// This will allow adjoin_term to work for polynomials with coefficients that are themselves polynomials.
...
function is_equal_to_zero(n) {
  return apply_generic("is_equal_to_zero", list(n));
}
